...
private:
	...
	ros::Publisher pub_points_, pub_center_, pub_waypoint_, pub_angle_, pub_speed_, pub_gps_;
	...
	finish_point1_, finish_point3_, sep_dynamic_, static_start_dist_, labacone_gradient_, labacone_offset_;
	...
	bool labacone_sign_ = true;
	double flag2_offset_; //start_heading_ = 0, cur_heading_ = 0;
	float yyy_=1000;
...
public:
	...
	geometry_msgs::Point get_waypoint();
	void laba_control();
